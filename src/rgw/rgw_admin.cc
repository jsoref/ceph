...
void usage()
{
  ...
  cout << "  gc list                        dump expired garbage collection objects (specify --include-all to list all entries, including unexpired)\n";
  cout << "  gc process                     manually process garbage (specify --include-all to process all entries, including unexpired)\n";
  ...
  cout << "   --access=<access>             Set access permissions for sub-user, should be one of read, write, readwrite, full\n";
  ...
  cout << "   --purge-data                  when specified, user removal will also purge all the user data\n";
  cout << "   --purge-keys                  when specified, subuser removal will also purge all the subuser keys\n";
  cout << "   --purge-objects               remove a bucket's objects before deleting it\n";
  cout << "                                 (NOTE: required to delete a non-empty bucket)\n";
  cout << "   --sync-stats                  option to 'user stats', update user stats with current stats reported by user's buckets indexes\n";
  ...
  cout << "   --skip-zero-entries           log show only dumps entries that don't have zero value in one of the numeric field\n";
  ...
  cout << "   --warnings-only               when specified with bucket limit check, list only buckets nearing or over the current max objects per shard value\n";
  cout << "   --bypass-gc                   when specified with bucket deletion, triggers object deletions by not involving GC\n";
  cout << "   --inconsistent-index          when specified with bucket deletion and bypass-gc set to true, ignores bucket index consistency\n";
