...
* os/bluestore: cap omap naming scheme upgrade transaction (`pr#42958 <https://github.com/ceph/ceph/pull/42958>`_, Adam Kupczyk, Igor Fedotov)
...
* osd/OSD: mkfs need wait for transaction completely finish (`pr#43418 <https://github.com/ceph/ceph/pull/43418>`_, Chen Fan)
...
* doc: typo fix in doc/dev/dev_cluster_deployment.rst: s/hostname/hostname/ (`pr#31515 <https://github.com/ceph/ceph/pull/31515>`_, Drunkard Zhang)
